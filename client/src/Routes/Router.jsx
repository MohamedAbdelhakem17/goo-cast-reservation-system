...
const ConfirmationBooking = lazy(() =>
  import("../pages/Confirmation-Booking/ConfirmationBooking")
);
...
const StudioManagement = lazy(() =>
  import("../pages/Admin-Dashboard/Studio-Management/StudioManagement")
);
const PriceManagement = lazy(() =>
  import("../pages/Admin-Dashboard/Price-Management/PriceManagement")
);
const ServiceManagement = lazy(() =>
  import("../pages/Admin-Dashboard/Service-Management/ServiceManagement")
);
const PageAnalytics = lazy(() =>
  import("../pages/Admin-Dashboard/Page-Analytics/PageAnalytics")
);
const BookingManagement = lazy(() =>
  import("../pages/Admin-Dashboard/Booking-Management/BookingManagement")
);
const CategoryManagement = lazy(() =>
  import("../pages/Admin-Dashboard/Category-Management/CategoryManagement")
);
const UserManagement = lazy(() =>
  import("../pages/Admin-Dashboard/User-Management/UserManagement")
);
const CouponManagement = lazy(() =>
  import("../pages/Admin-Dashboard/Coupon-Management/CouponManagement")
);
const AddStudio = lazy(() =>
  import("../pages/Admin-Dashboard/Studio-Management/Add-Studio/AddStudio")
);
...
const UserBookings = lazy(() =>
  import("../pages/User-Dashboard/User-Bookings/UserBookings")
);
