...
export default function ConfirmationBooking({ booking }) {
    const { studio, date, startSlot, endSlot, duration, selectedPackage, selectedAddOns, personalInfo } =
        booking
    ...
    const totalAddOnPrice = selectedAddOns?.reduce((acc, item) => {
        return acc + (item.quantity > 0 ? item.price * item.quantity : 0)
    }, 0) || 0
    const totalPrice = Number(studio?.price || 0) + totalAddOnPrice + (selectedPackage?.price || 0)
                ...
                <div className="p-6 md:p-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <motion.div
                            ...
                            className={`bg-white p-6 rounded-2xl shadow-lg border ${activeSection === "studio" ? "border-main/70 ring-2 ring-main/50" : "border-gray-100"
                        ...
                        >
                            <div className="flex flex-col md:flex-row gap-6 items-center  md:items-start">
                                ...
                                <div className="flex-1 text-center md:text-left ">
                                    <h3 className="text-2xl font-bold text-gray-800">{studio.name}</h3>
                        ...
                        <motion.div
                            ...
                            onMouseLeave={() => setActiveSection(null)}
                            className={`bg-white p-6 rounded-2xl shadow-lg border ${activeSection === "date" ? "border-main/70 ring-2 ring-main/50" : "border-gray-100"
                                } transition-all duration-300`}
                        >
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div className="flex items-start gap-4">
                                    <div className="bg-indigo-50 p-3 rounded-xl">
                                        <i className="fa-regular fa-circle-check text-sm text-indigo-600"></i>
                                    </div>
                                    <div>
                                        <h4 className="font-semibold text-lg text-gray-800">Date & Time</h4>
                                        <p className="text-gray-700 font-medium mt-1">{formattedDate}</p>
                                    </div>
                                </div>

                                <div className="mt-4 md:mt-0 md:ml-4 flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-xl">
                                    <i className="fa-regular fa-clock text-sm text-indigo-600"></i>
                                    <div>
                        ...
                        <motion.div
                            ...
                            onMouseLeave={() => setActiveSection(null)}
                            className={`bg-white p-6 rounded-2xl shadow-lg border ${activeSection === "package" ? "border-main/70 ring-2 ring-main/50" : "border-gray-100"
                                } transition-all duration-300`}
                        >
                            <div className="flex flex-col md:flex-row md:items-center gap-4">
                                <div className="bg-indigo-50 p-3 rounded-xl">
                                    <i className="fa-solid fa-cube text-sm text-indigo-600"></i>
                                </div>

                                <div className="flex-1">
                                    <h4 className="font-semibold text-lg text-gray-800">Selected Package</h4>
                                    <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div className="bg-gray-50 p-3 rounded-xl">
                                            ...
                                            <p className="font-medium text-gray-800">{selectedPackage.duration} hours</p>
                                        </div>

                                        <div className="bg-main/80 p-3 rounded-xl">
                                            <p className="text-sm text-white">Package Price</p>
                                            <p className="font-bold text-white">{selectedPackage.price} EGP</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <motion.div
                            ...
                            onMouseLeave={() => setActiveSection(null)}
                            className={`bg-white p-6 rounded-2xl shadow-lg border ${activeSection === "addons" ? "border-main/70 ring-2 ring-main/50" : "border-gray-100"
                                } transition-all duration-300`}
                        >
                            <div className="flex items-center gap-4 mb-4">
                                <div className="bg-indigo-50 p-3 rounded-xl">
                                    <i className="fa-solid fa-puzzle-piece text-sm text-indigo-600"></i>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-lg text-gray-800">Selected Add-ons</h4>
                                    <p className="text-sm text-gray-500">Additional services for your session</p>
                                </div>
                            </div>
                                    ...
                                    selectedAddOns.map((addOn, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-right">
                                                <p className="font-bold text-main">{addOn.totalPrice} EGP</p>
                                            </div>
                                        </motion.div>
                                    ))
                                ) : (
                        ...
                        <motion.div
                            ...
                            onMouseLeave={() => setActiveSection(null)}
                            className={`bg-white p-6 rounded-2xl shadow-lg border ${activeSection === "personal" ? "border-main/70 ring-2 ring-main/50" : "border-gray-100"
                                } transition-all duration-300`}
                        >
                            <div className="flex items-center gap-4 mb-4">
                                <div className="bg-indigo-50 p-3 rounded-xl">
                                    <i className="fa-regular fa-user text-sm text-indigo-600"></i>
                                </div>
                                <div>
                            ...
                            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <p className="font-medium text-gray-800">{personalInfo.brand}</p>
                                </div>
                            </div>
                        </motion.div>
                            ...
                            <div className="relative p-6 md:p-8 rounded-2xl text-white">
                                <div className="flex flex-col md:flex-row justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-white/80 text-sm mt-1">All prices include taxes and fees</p>
                                    </div>
                    ...
                    >
                        ...
                        <div className="mt-8 bg-gray-50 p-4 rounded-xl border border-gray-200 my-3">
                            {
                                !isAuthenticated && <p className="text-gray-700 mb-4 text-sm md:text-base">
                                    If you already have an account,{" "}
                                    <span className="font-semibold text-main">log in</span> to confirm your booking, or continue as a guest.
                                </p>

                            }
                            <div className="flex justify-end">
                                {isAuthenticated ? (
                                    <button className="px-6 py-3 bg-indigo-600 text-white rounded-2xl font-semibold shadow-md hover:bg-indigo-700 transition">
                                        Confirm Booking
                                    </button>
                                ) : (
                                    <button className="px-6 py-3 bg-white border border-gray-300 text-gray-800 rounded-2xl font-semibold shadow-sm hover:bg-gray-100 transition">
                                        Book as Guest
                                    </button>
                                )}
                            </div>
                        ...
                        <div className="inline-flex items-center gap-2 text-gray-500 bg-gray-50 px-4 py-2 rounded-full text-sm">
                            <i className="fa-regular fa-circle-check text-xs text-green-500"></i> A confirmation has been sent to your email
                        </div>
