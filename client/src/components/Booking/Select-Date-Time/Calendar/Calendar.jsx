...
export default function Calendar() {
  ...
  return (
    <div className="w-full mx-auto p-6 bg-white">
      ...
      {/* Calendar */}
      {
        isLoading ? <Loading /> : <div className="border border-gray-200 rounded-lg overflow-hidden">
          ...
          <div className="grid grid-cols-7">
            {calendarDays.map((day, index) => (
              <div
                ...
                ${(selectedDate ? isSelected(day.date) : isToday(day.date)) ? "bg-blue-100 ring-2 ring-main ring-inset" : ""}
              `}
                onClick={() => {
