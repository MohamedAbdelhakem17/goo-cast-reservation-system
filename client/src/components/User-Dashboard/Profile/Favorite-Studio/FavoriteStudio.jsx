...
export default function FavoriteStudio({ favoriteStudio }) {
                ...
                <motion.div
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <button onClick={() => handleQuickBooking()}
                            className="w-full bg-rose-50 hover:bg-rose-100 text-rose-600 font-medium py-2 px-4 rounded-lg flex
