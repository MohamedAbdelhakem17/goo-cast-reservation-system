        ...
        <div className={`relative mb-8 ${className}`}>
            ...
            <div className="relative">
                ...
                <motion.div
                    ...
                    className={`absolute bottom-1 left-0 w-full bg-gradient-to-r ${errors && touched ? "from-red-400 to-red-600" : "from-[#ed1e26] to-[#ff5b60]"
                ...
                <textarea
                    ref={inputRef}
                    className={`w-full py-3 px-3 bg-transparent border-0 border-b-2 text-gray-800 text-base focus:ring-0 focus:outline-none resize-none ${errors && touched
                        ? "border-b-red-500"
                        : isFocused
                            ? "border-b-[#ed1e26]"
                            : "border-b-gray-300"
