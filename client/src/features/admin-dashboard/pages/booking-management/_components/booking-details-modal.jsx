    ...
    <AnimatePresence mode="wait">
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/10 px-4 backdrop-blur-sm">
        <motion.div
          ...
          className="max-h-[90vh] w-full max-w-7xl overflow-y-auto rounded-xl bg-white shadow-xl"
        >
          <div className="p-6">
            <div className="mb-6 flex items-start justify-between">
              <h2 className="text-2xl font-bold text-gray-800">Booking Details</h2>
              <button onClick={closeModel} className="text-gray-500 hover:text-gray-700">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-gray-800">Booking Time</h3>
                <div className="rounded-lg bg-gray-50 p-4">
                  <p className="text-sm text-gray-600">
              ...
              {booking.package && (
                <div>
                  ...
                  <div className="rounded-lg bg-gray-50 p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      duration: {booking?.package?.duration || "no"} hour
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-semibold text-gray-800">
                        Package Price:
              ...
              booking.addOns.some(
                (addon) =>
                  addon && Object.keys(addon).length > 0 && addon.name && addon.quantity,
              ) ? (
                <div>
                  <h3 className="mb-2 text-lg font-semibold text-gray-800">Add-ons</h3>
                  <div className="rounded-lg bg-gray-50 p-4">
