...
export default function AdminSelectPackage({ selectPackage, selectedPackage, formik }) {
  // Localization
  ...
  const handleSelectPackage = ({ _id, name, price }) => {
    ...
    formik.setFieldTouched("selectedPackage", true, true);
    formik.validateField("selectedPackage");
  };
