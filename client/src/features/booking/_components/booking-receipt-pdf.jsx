      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ flexDirection: "row", marginBottom: 20 }}>
          ...
          <View style={styles.col}>
            ...
            <Text>Studio: {booking.studio.name?.en}</Text>
            <Text>
              Time: {timeConvert(booking.startSlot)} ({booking.duration}h){" "}
            </Text>
        ...
        {booking.package && (
          <View style={{ marginBottom: 20 }}>
            ...
            <View style={[styles.row, styles.tableRow]}>
              <Text>{booking?.package?.name?.en}</Text>
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            {booking.addOns.map((addon, i) => (
              <View key={i} style={[styles.row, styles.tableRow]}>
                <Text style={{ textAlign: "start", width: 200 }}>
                  {addon.item.name?.en}
                </Text>
