...
export default function Duration({ isOpen, setIsOpen }) {
  ...
  return (
    <div className="relative z-[30]">
      {/* Main Display */}
      <div
        className="flex w-full cursor-pointer items-center justify-between gap-4 rounded-md border-2 border-gray-100 px-3 py-2 transition-colors hover:border-gray-200 sm:w-auto"
        onClick={() => setIsOpen(!isOpen)}
      >
        <div className="flex items-center gap-2">
          <Clock className="h-4 w-4 text-gray-600" />
          <span className="hidden border-r-2 border-gray-200 pr-2 text-sm text-gray-700 sm:inline-block">
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-full right-0 z-[500] mt-2 w-[250px] overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl lg:left-0"
            >
              {/* Header */}
              ...
              {/* Duration Options */}
              <div className="min-h-[300px] overflow-y-auto py-2">
