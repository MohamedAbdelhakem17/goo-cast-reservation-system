...
//       whileHover={{ y: -5 }}
//       className="col-span-1 cursor-pointer py-5"
...
//         {/* Description */}
//         <motion.p
//           className="my-2.5 border-b border-gray-300 pb-4 text-sm font-normal text-gray-600"
...
//       <motion.div
//         className="grid grid-cols-1 gap-6 md:grid-cols-2 md:px-8 lg:grid-cols-3 lg:px-0"
