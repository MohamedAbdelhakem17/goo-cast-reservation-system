...
export default function Taps({ description, facilities, equipment }) {
    const tabs = [
        { label: "Description", id: 1, content: <Description description={description} /> },
        { label: "Facilities", id: 2, content: <Facilities facilities={facilities} /> },
        { label: "Equipment", id: 3, content: <Equipment equipment={equipment} /> },
    ];
