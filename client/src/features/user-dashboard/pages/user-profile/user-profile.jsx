  ...
  return (
    <>
      <div className="container max-w-8xl py-5 px-4 mx-auto">
        ...
        <Header
          user={userData?.data}
          workspace={userDataStats?.data?.userWorkSpace}
        />
        ...
        <div className="grid gap-8">
          ...
          {Boolean(
            Object.keys(userDataStats?.data?.nextBookingAfterToday).length
          ) && (
            <UpcomingBooking
          ...
          <div className="grid md:grid-cols-2 gap-8">
            // Last user booked
            {Boolean(
              Object.keys(userDataStats?.data?.lastBookingBeforeToday).length
            ) && (
              <motion.div
