...
import CategoryForm from "../../../components/Admin-Dashboard/Category-Management/Category-Form/CategoryForm"
import CategoryList from "../../../components/Admin-Dashboard/Category-Management/Category-List/CategoryList"
...
export default function CategoryManagement() {
  ...
  const handeleupdateCategory = (updatedCategory) => {
          ...
          <div className="bg-white  rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <AnimatePresence mode="wait">
                {isFormOpen ? (
                  <CategoryForm key="form" initialCategory={editingCategory} onSubmit={editingCategory ? handeleupdateCategory
