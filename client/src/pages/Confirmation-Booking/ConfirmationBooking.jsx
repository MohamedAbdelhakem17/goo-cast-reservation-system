...
const PriceRow = ({ label, value, bold = false }) => (
  <div className="flex justify-between py-2 items-center">
    ...
    <span
      className={`font-medium ${bold ? "text-lg font-bold text-gray-900" : ""}`}
    >
      {value}
    </span>
  </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-md font-bold bg-gray-300 rounded-md px-3 py-2">
                  {bookingData?._id}
                </span>
              </div>
              <p className="text-sm text-gray-600">
                Please keep this reference number for your records. You'll need
                it for any changes or inquiries.
              </p>
            </motion.div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-3 divide-y divide-gray-200">
                <PriceRow
                  label={bookingData?.package?.name}
            ...
            >
              ...
              <div>
                ...
                <motion.button
                  className="w-full px-4 py-2 my-2  bg-red-500 text-white rounded-lg hover:bg-red-600 transition font-medium"
                  onClick={() => {
                    localStorage.removeItem("bookingData");
                    localStorage.removeItem("bookingStep");
                    localStorage.removeItem("bookingConfirmation");
            ...
            >
              ...
              <div className="space-y-3 text-sm">
                ...
                <DetailRow
                  ...
                  value="8 Abd El-Rahman Fahmy , Qasr El Nile, Garden City"
                />
              </div>
            </motion.div>
          </div>
