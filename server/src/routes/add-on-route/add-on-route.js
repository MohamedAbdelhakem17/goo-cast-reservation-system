...
router.route('/')
    .post(addOnController.addonsImageUpload, addOnController.addonsImageManipulation, addOnController.createAddOn); // Create a new add-on

router.route('/:id')
    .put(addOnController.addonsImageUpload, addOnController.addonsImageManipulation, addOnController.updateAddOn) // Update add-on by ID    
